...
document.addEventListener("DOMContentLoaded", function () {
  ...
  loginForm.addEventListener("submit", async function (event) {
    ...
    try {
      const response = await fetch('https://fastapiapp-production.up.railway.app/docs/login', {
          method: 'POST',
          body: formData,
      });
...
url = 'https://fastapiapp-production.up.railway.app/docs/login'
async function fetchData(url) {
  ...
  signupForm.addEventListener("submit", async function (event) {
      ...
      try {
          const response = await fetch('https://fastapiapp-production.up.railway.app/docs/users/CreateUser', {
              method: 'POST',
              headers: {
